            ...
            <nav class="bg-white/90 backdrop-blur-sm dark:bg-gray-800/90 shadow-md relative z-50">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink v-if="$page.props.user.roles.includes('admin')" :href="route('dashboard')" :active="route().current('dashboard')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('dashboard')}">Admin</NavLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm">
                        ...
                        <ResponsiveNavLink v-if="$page.props.user.roles.includes('admin')" :href="route('dashboard')" :active="route().current('dashboard')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('dashboard')}">Admin</ResponsiveNavLink>
