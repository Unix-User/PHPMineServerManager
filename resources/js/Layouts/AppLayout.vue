            ...
            <nav class="bg-white/90 backdrop-blur-sm dark:bg-gray-800/90 shadow-md relative z-50">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('dashboard')}">Painel de Controle</NavLink>
                                <NavLink v-if="$page.props.user.roles.includes('admin')" :href="route('backups')" :active="route().current('backups')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('backups')}">Gerenciamento de Backups</NavLink>
                                <NavLink v-if="$page.props.user.roles.includes('admin')" :href="route('rcon')" :active="route().current('rcon')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('rcon')}">Controle Rcon</NavLink>
                                <NavLink :href="route('shop')" :active="route().current('shop')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('shop')}">Assinatura VIP</NavLink>
                                <NavLink :href="route('map')" :active="route().current('map')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('map')}">Mapa Interativo</NavLink>
                                <NavLink href="help" :active="route().current('help')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('help')}">Tutoriais e Guias</NavLink>
                                <NavLink :href="route('updates')" :active="route().current('updates')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:text-blue-500 dark:hover:text-blue-300" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('updates')}">Atualizações do Sistema</NavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm">
                        <ResponsiveNavLink :href="route('dashboard')" :active="route().current('dashboard')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('dashboard')}">Painel de Controle</ResponsiveNavLink>
                        <ResponsiveNavLink v-if="$page.props.user.roles.includes('admin')" :href="route('backups')" :active="route().current('backups')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('backups')}">Gerenciamento de Backups</ResponsiveNavLink>
                        <ResponsiveNavLink v-if="$page.props.user.roles.includes('admin')" :href="route('rcon')" :active="route().current('rcon')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('rcon')}">Controle Rcon</ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('shop')" :active="route().current('shop')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('shop')}">Assinatura VIP</ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('map')" :active="route().current('map')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('map')}">Mapa Interativo</ResponsiveNavLink>
                        <ResponsiveNavLink href="help" :active="route().current('help')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('help')}">Tutoriais e Guias</ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('updates')" :active="route().current('updates')" class="font-semibold text-gray-800 dark:text-gray-200 transition-colors hover:bg-gray-100/80 dark:hover:bg-gray-700/80" v-bind:class="{'text-blue-600 dark:text-blue-400': route().current('updates')}">Atualizações do Sistema</ResponsiveNavLink>
                    </div>
