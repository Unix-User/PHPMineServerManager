...
<template>
    <AppLayout title="Tutoriais">
<template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">                Tutoriais
            </h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p
                            class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed text-center"
                        >
                            Bem-vindo à página de ajuda. Aqui, você encontrará
                            uma variedade de tutoriais úteis para ajudá-lo a
                            navegar e aproveitar ao máximo o servidor.
                        </p>
                        <div
                            class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8"
                        >
                            <a
                                :href="route('factionCommands')"
