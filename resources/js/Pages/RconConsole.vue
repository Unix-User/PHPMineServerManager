            ...
            try {
                ...
                if (response.data) {
                    ...
                    const sanitizedMessage = message.replace(
                        /\u00A7[0-9A-FK-ORa-fk-or]/g,
                        ""
                    ); // Convert Minecraft color codes but keep line breaks
    ...
    <AppLayout title="Console">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-5"
                >
                    <div class="container mx-auto" id="content">
                        <div id="consoleRow">
                            <div
                                class="rounded shadow-sm p-4 mb-4 bg-gray-100 dark:bg-gray-900"
                                id="consoleContent"
                            >
                                <div class="flex justify-between items-center">
                                    ...
                                    >
                                        <i class="fas fa-terminal"></i> Shel de comandos RCON
                                    </h3>
                                    <div class="space-x-2">
                                        <a
                                ...
                                <div class="mt-4 bg-blue-100 dark:bg-gray-700 p-4 rounded">
                                    <ul class="list-none overflow-y-auto h-64">
                                        <li
                                            v-for="(message, index) in messages"
                                            :key="index"
                                            class="p-2 bg-white dark:bg-gray-800 rounded mb-2 shadow text-gray-900 dark:text-gray-200"
                                        >
                                            {{ message }}
                                        </li>
                                    </ul>
                            ...
                            >
                                <input
                                    type="text"
                                    class="form-input flex-grow rounded p-2"
                                    id="txtCommand"
                                ...
                                <button
                                    type="button"
                                    class="btn btn-warning bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded"
                                    id="btnClearLog"
                                    @click="clearLog"
                                    title="Limpar Log"
                                >
