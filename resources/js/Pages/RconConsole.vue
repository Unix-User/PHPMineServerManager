    ...
    <AppLayout title="Console">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm overflow-hidden shadow-xl sm:rounded-lg transition-all duration-300 ease-in-out hover:shadow-2xl p-8">
                    <div class="container mx-auto">
                        <div class="space-y-4">
                            <div class="rounded-lg shadow-sm p-4 bg-white/80 dark:bg-gray-800/60 backdrop-blur-sm">
