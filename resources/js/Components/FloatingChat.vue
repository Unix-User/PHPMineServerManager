<template>
    <div>
        <div v-if="isOpen" class="fixed bottom-3 right-2 rounded-lg p-2 shadow-lg bg-white shadow border border-gray-300">
            ...
            <div class="w-72 h-96 bg-gray-200 border border-gray-300 rounded-lg overflow-auto" ref="chatContainer">
                <div>
                    <div v-for="message in messages" :key="message.id" class="bg-white rounded-lg m-2 p-2 shadow-sm">
                        <p>
                ...
                <div class="fixed bottom-5 w-72 flex justify-between p-2 bg-gray-200 border-t border-b border-gray-300 rounded-lg">
                    <input type="text" v-model="message" placeholder="Digite sua mensagem aqui..." class="flex-grow mr-2 p-2 rounded-lg border border-gray-300" @keyup.enter="sendMessage"/>
                    <button @click="sendMessage" class="bg-blue-500 text-white rounded-lg p-2 cursor-pointer">Enviar</button>
                </div>
            </div>
        </div>
        <div class="fixed bottom-2 right-2 rounded-full p-0 shadow-lg bg-white border border-gray-300" v-else>
