...
<template>
    <div>
        <div v-if="show && message" :class="{
            'bg-indigo-500 dark:bg-indigo-800': style == 'success', 
            'bg-red-700 dark:bg-red-900': style == 'danger'
        }">
                ...
                <div class="flex items-center justify-between flex-wrap">
                    ...
                    <div class="shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{
                                'hover:bg-indigo-600 focus:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:bg-indigo-700': style == 'success', 
                                'hover:bg-red-600 focus:bg-red-600 dark:hover:bg-red-700 dark:focus:bg-red-700': style == 'danger'
                            }"
                            aria-label="Dismiss"
