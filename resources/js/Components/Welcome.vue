...
<template>
    ...
    >
        ...
        <div
            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-6 leading-relaxed"
        >
            <div class="badge bg-indigo-500/90 dark:bg-indigo-600/90 hover:bg-indigo-600/90 dark:hover:bg-indigo-700/90 text-white px-4 py-2 rounded-lg shadow-md transition-all duration-200 backdrop-blur-sm flex items-center justify-center">
            ...
            <div class="badge bg-emerald-500/90 dark:bg-emerald-600/90 hover:bg-emerald-600/90 dark:hover:bg-emerald-700/90 text-white px-4 py-2 rounded-lg shadow-md transition-all duration-200 backdrop-blur-sm flex items-center justify-center">
            ...
            <div class="badge bg-amber-500/90 dark:bg-amber-600/90 hover:bg-amber-600/90 dark:hover:bg-amber-700/90 text-white px-4 py-2 rounded-lg shadow-md transition-all duration-200 backdrop-blur-sm flex items-center justify-center">
                    ...
                    <div class="flex items-center">
                        ...
                        >
                            <svg
                                ...
                                height="1.5em"
                                viewBox="0 0 640 512"
                                class="text-indigo-600 dark:text-indigo-400 transition-colors"
                                fill="currentColor"
                            >
                                <path
                    ...
                    <div class="flex items-center">
                        ...
                        >
                            <svg
                                ...
                                height="1.5em"
                                viewBox="0 0 576 512"
                                class="text-rose-600 dark:text-rose-400 transition-colors"
                                fill="currentColor"
                            >
                                <path
